    ...
    const handler = ((window as unknown) as Record<string, any>).PaystackPop.setup({
      ...
      metadata: {
        custom_fields: [
          ...
          { display_name: "Contact Person", variable_name: "contact_person", value: formData.contactPerson },
          { display_name: "Phone", variable_name: "phone", value: formData.phone },
          { display_name: "Product Type", variable_name: "product_type", value: formData.productType },
        ],
      },
      onClose: () => {
        setIsProcessing(false);
      ...
      callback: async (response: any) => {
        ...
        try {
          ...
          if (!apiResponse.ok) {
            ...
            setError(errorData.error || "Failed to complete vendor registration");
            setIsProcessing(false);
            return;
          }
          ...
          setPaymentSuccess({
            ...
            ticketId,
            qrCode: `data:image/svg+xml;base64,${btoa(`<svg xmlns="http://www.w3.org/2000/svg"><text>${ticketId}</text></svg>`)}`,
          });
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          >
            ...
            <div className="bg-white/5 border border-brand-orange/30 rounded-lg p-6 mb-8">
              <p className="text-xs text-gray-400 uppercase mb-2">Your Ticket ID</p>
    ...
    <div className="min-h-screen bg-[#050505] py-20">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-400 mt-2">Secure your booth for Ilorin Car Show 3.0</p>
        </div>
        ...
        >
          ...
          <form onSubmit={handlePayment} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="businessName" className="text-xs uppercase tracking-wider text-gray-500">
                Business Name
              </Label>
              <Input
                id="businessName"
            ...
            {/* Contact Person */}
            <div className="space-y-2">
              <Label htmlFor="contactPerson" className="text-xs uppercase tracking-wider text-gray-500">
                Contact Person Name
              </Label>
              <Input
                id="contactPerson"
            ...
            {/* Phone */}
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-xs uppercase tracking-wider text-gray-500">
                Phone Number
              </Label>
              <Input
                id="phone"
            ...
            {/* Product Type */}
            <div className="space-y-2">
              <Label htmlFor="productType" className="text-xs uppercase tracking-wider text-gray-500">
                Product Type
              </Label>
              <select
                id="productType"
