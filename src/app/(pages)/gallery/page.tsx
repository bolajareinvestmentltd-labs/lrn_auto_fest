      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-brand-orange/10 to-brand-blue/10 border border-white/10 rounded-2xl">
          <div className="text-center">
            <p className="text-sm uppercase tracking-widest text-neutral-400 mb-3">Over</p>
            <p className="text-6xl md:text-7xl font-bold text-brand-orange mb-2">17,000+</p>
            <p className="text-2xl font-bold text-white mb-2">Spectators</p>
            <p className="text-neutral-400 text-sm">Since 2024</p>
          </div>
        </div>

        {/* CTA */}
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold text-white mb-2">Ready to be part of Ilorin Car Show 3.0?</h3>
          <p className="text-neutral-400 mb-6">
            <span className="block text-brand-orange font-semibold mb-2">The Reborn Edition</span>
            Don&apos;t miss the biggest automotive event in Northern Nigeria!
          </p>
          <button
        ...
        {showComingSoonModal && (
          <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-white/20 p-8 max-w-sm w-full">
                ...
                <p className="text-neutral-300 mb-6">🎟️ Ticket sales will be available soon!</p>
                <button
                  onClick={() => setShowComingSoonModal(false)}
                  className="w-full px-4 py-2 bg-brand-orange hover:bg-brand-orange/90 text-white font-bold rounded-lg transition-colors"
                >
                  Got it
                </button>
              </div>
